...
export default function PackageDeliveryScreen({ navigation }) {
    ...
    return (
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            {/* <ImageSelectionContainer defaultValue={["https://i.ibb.co/wYP8Bqx/b8d47b88e9e8.jpg"]} onChange={(values: string[]) => {
                console.log('PackageDeliveryScreen', values);
            }} /> */}
            {/* <Text>Package Delivery, coming soon...</Text> */}
        </View>
    )
}